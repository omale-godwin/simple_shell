...
/**
 * in_terminal - returns true if shell is interactive mode
 * @info: struct address
 *
 * Return: 1 if in_terminal mode else 0
 */

int in_terminal(info_s *info)
{
...
/**
 * is_a_delimiter - checks if a character is a delimiter
